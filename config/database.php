        ...
        */
        ...
        'connections' => [
            ...
            'mysql' => [
                ...
                'read' => [
                    [
                        'host'      => env('DB_HOST', 'dev.cjkt.com'),
                        'port'      => env('DB_PORT', 53366),
                        'database'  => env('DB_DATABASE', 'cjkt_online'),
                        'username'  => env('DB_USERNAME', 'cjkt_dev'),
                        'password'  => env('DB_PASSWORD', 'BX^pVnxjmDG!'),
                    ],
                    [
                        'host'      => env('DB_HOST', 'dev.cjkt.com'),
                        'port'      => env('DB_PORT', 53366),
